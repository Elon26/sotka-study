                ...
                <div className={styles.description}>
                    ...
                    <div className={styles.bottom}>
                        <div className={styles.faceArea}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="53" height="18.974" viewBox="0 0 53 19" fill="none" className={styles.faceLine}><path d="M0.903601 18.5082C8.26471 6.30825 28.4233 -9.94675 51.8655 12.8846" stroke="currentColor" strokeWidth="1.6"></path></svg>
                        </div>
                    </div>
                </div>
                <div className={styles.media}>
